    ...
    return (
        <div className='my-25'>
            ...
            <Section title='Coleções em destaque' axle='flex-col' align='center'>
                <div className="flex flex-row gap-12 px-5 justify-center text-sm text-dark-gray-2 font-bold" >
                    <div className=' h-20 w-20 rounded-full bg-white p-3 cursor-pointer'>
                    ...
                    <div className=' h-20 w-20 rounded-full bg-white p-3 cursor-pointer'>
                        <img className="mx-auto block h-17 sm:mx-0 sm:shrink-0" src="/tenis-icon.svg" alt="" />
                        <p className="pt-5 pb-10 text-center">Tênis</p>
                    </div>
